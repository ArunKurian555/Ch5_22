...
namespace CBlink
{
    public interface IZones
    {
        ...
        void Zone250(ZonesStringInputSigDelegate callback);
    ...
    internal class Zones : IZones, IDisposable
    {
        ...
        public void Zone250(ZonesStringInputSigDelegate callback)
        {
            for (int index = 0; index < Devices.Count; index++)
            {
                callback(Devices[index].SmartObjects[ControlJoinId].StringInput[Joins.Strings.Zone250], this);
            }
        }
